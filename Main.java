    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (res.isValid()) {
                ...
                // Rows
                for (Map.Entry<Integer, Map<Integer, List<Integer>>> rowEntry : res.getRowDuplicates().entrySet()) {
                    int rowIdx = rowEntry.getKey();
                    Map<Integer, List<Integer>> map = rowEntry.getValue();
                ...
                System.out.println("------------------------------------------");
                // Cols
                for (Map.Entry<Integer, Map<Integer, List<Integer>>> colEntry : res.getColDuplicates().entrySet()) {
                    int colIdx = colEntry.getKey();
                    Map<Integer, List<Integer>> map = colEntry.getValue();
                    for (Map.Entry<Integer, List<Integer>> e : map.entrySet()) {
                ...
                System.out.println("------------------------------------------");
                // Boxes
                for (Map.Entry<Integer, Map<Integer, List<Integer>>> boxEntry : res.getBoxDuplicates().entrySet()) {
                    int boxIdx = boxEntry.getKey();
                    Map<Integer, List<Integer>> map = boxEntry.getValue();
                    for (Map.Entry<Integer, List<Integer>> e : map.entrySet()) {
